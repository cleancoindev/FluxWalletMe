...
function getTribeDetails(tribe) {
    ...
    $("#copyTribeButton").attr("data-clipboard-text", 'https://fluxwallet.me/tribe.html?id=' + tribeID + "#");
}
    ...
    lobby.createTribe.sendTransaction(
        ...
        function (error, result) { //get callback from function which is your transaction key
            if (!error) {
                ...
                newTribeLink = 'https://fluxwallet.me/tribe.html?id=' + tribeNumber + "#"
...
function joinTribeAlert(){
    ...
    <img id="loginLogo" src="assets/img/tribes/piggy.gif" class="ui image etc-logo center-larger" />
    `
    )
}
